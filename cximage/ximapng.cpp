...
//		info.nBkgndIndex = 0; //enable transparency
	...
	head.biClrUsed = info_ptr->num_palette;
	...
	if (info.nBkgndIndex!=-1 && image_background)
	{
		RGBQUAD rgb;

		rgb.rgbRed   = (BYTE)image_background->red;
		rgb.rgbGreen = (BYTE)image_background->green;
		rgb.rgbBlue  = (BYTE)image_background->blue;
		rgb.rgbReserved = 0;	// <vho>
